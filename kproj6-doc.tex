...
\section{Assignment}
The assignment set forth by SINTEF is to improve the current solution to be able to serve the user with dynamically created views of the data. This way, the user will be able to single out the information that is important in any given situation, and not be constrained by pre defined selections of data. 
